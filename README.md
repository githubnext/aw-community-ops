...
4. Validate [`labelling-correction-collector.yml`](.github/workflows/labelling-correction-collector.yml) by sending one `label-correction` `repository_dispatch` event.
